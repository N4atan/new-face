...
export default function Hero() {
  return (
    ...
    <section
      ...
      style={{
        backgroundImage:
          'url(/assets/modern-living-room-interior-design.jpg)',
      }}
    >
      ...
      <div className="hero-content text-primary-content text-center">
        <div className="flex flex-col gap-5 max-w-xl">
          ...
          <div className="flex flex-col md:flex-row flex-wrap justify-center gap-4 ">
            <div className="aura aura-dual text-primary-content w-full md:w-auto">
              <button className="btn btn-primary btn-shadow btn-lg w-full ">
              <svg
                role="img"
                viewBox="0 0 24 24"
