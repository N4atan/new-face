      ...
      <div className="hero-content flex-col lg:flex-row-reverse max-w-6xl shadow-md rounded-2xl p-6 sm:p-10 gap-8">
        ...
        <figure className="diff aspect-1/1 rounded-2xl" tabIndex={0}>
          <div className="diff-item-1" role="img" tabIndex={0}>
            <img alt="daisy" src="/assets/antes.png" />
          </div>
        ...
        <div className="w-full text-left">
          ...
          <p className="py-6 text-base text-lg text-base-content/85 leading-relaxed font-normal">
            ...
            Clique no botão abaixo e chame direto no WhatsApp para solicitar seu orçamento sem compromisso. Teremos prazer em ajudar com o seu projeto!
          </p>


          <div className="aura aura-dual text-primary w-full">
            <button className="btn btn-primary btn-shadow w-full btn-lg  ">
              <svg
                role="img"
                viewBox="0 0 24 24"
